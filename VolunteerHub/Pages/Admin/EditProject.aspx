<%@ Page Title="Edit Project" Language="C#" MasterPageFile="~/DashboardMaster.Master" AutoEventWireup="true" CodeBehind="EditProject.aspx.cs" Inherits="VolunteerHub.Pages.Admin.EditProject" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div class="vh-page-header">
        <div>
            <h1 class="vh-page-title">Edit Project</h1>
            <p class="vh-page-desc">Update project details.</p>
        </div>
    ...
    <div class="vh-card" style="max-width:760px;">
        <div class="vh-card-body">
            ...
            <div class="vh-form-group">
                ...
                <asp:TextBox ID="txtTitle" runat="server" CssClass="vh-input" MaxLength="200" />
            ...
            <div class="vh-form-group">
                ...
                <asp:TextBox ID="txtDescription" runat="server" CssClass="vh-input" TextMode="MultiLine" Rows="4" />
            </div>

            <div class="vh-form-group">
                <label class="vh-label">Location</label>
                <asp:TextBox ID="txtLocation" runat="server" CssClass="vh-input" MaxLength="300" />
            </div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="vh-form-group">
                        ...
                        <asp:TextBox ID="txtMaxVols" runat="server" CssClass="vh-input" TextMode="Number" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="vh-form-group">
                        <label class="vh-label">Required Hours per Volunteer</label>
                        <asp:TextBox ID="txtHoursRequired" runat="server" CssClass="vh-input" TextMode="Number" />
                    </div>
                </div>
            </div>
